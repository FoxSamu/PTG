...
/**
 * 3D Voronoi (voronoi, distance to point) noise generator.
 */
public class Worley3D extends BaseNoise3D {
     ...
     */
    public Worley3D(int seed, double scale) {
        super(seed, scale);
    }
     ...
     */
    public Worley3D(int seed, double scaleX, double scaleY, double scaleZ) {
