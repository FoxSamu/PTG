...
package net.rgsw.ptg.noise;

import net.rgsw.ptg.noise.util.NoiseMath;

/**
 * Generic class for 3D noise generator implementations ({@link Noise3D} generators).
 */
public abstract class BaseNoise3D implements Noise3D {
    protected int seed;
