...
/**
 * Repeating 3D Discrete noise generator.
 */
public class RepetitiveDiscrete3D extends RepetitiveNoise3D {
     ...
     */
    public RepetitiveDiscrete3D(int seed, int repeat) {
        super(seed, repeat);
    }
     ...
     */
    public RepetitiveDiscrete3D(int seed, double scale, int repeat) {
     ...
     */
    public RepetitiveDiscrete3D(int seed, double scaleX, double scaleY, double scaleZ, int repeatX, int repeatY, int repeatZ) {
